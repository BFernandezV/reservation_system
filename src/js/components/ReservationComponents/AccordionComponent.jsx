          ...
          <div className="flex justify-between w-full">
            <div className="flex items-center">
              ...
              <div className="ml-2 text-sm">
                ...
                <p className="text-xs font-normal text-text_secondary text-left">{`Tiempo estimado: ${elementAccordion.duration}`}</p>
              </div>
            </div>
            <span className="align-bottom inline">
              $ {elementAccordion.price}
            </span>
          </div>
        </AccordionHeader>
        <AccordionBody className="!border border-border_secondary p-2 rounded-md">
          {elementAccordion.description}
        </AccordionBody>
      </Accordion>
    </Fragment>
  );
